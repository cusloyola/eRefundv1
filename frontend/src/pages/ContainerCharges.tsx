...
import {
    containerChargesRows,
    containerChargesColumns,
    ROWS_PER_PAGE,
} from "../../dummy_data/containerChargesData";

const ContainerCharges: React.FC = () => {
    const [search, setSearch] = useState("");
    const [searchBy, setSearchBy] = useState("controlNo");
    const [page, setPage] = useState(1);
    const [dateFrom, setDateFrom] = useState("2020-02-08");
    const [dateTo, setDateTo] = useState("2026-02-02");

    const filteredRows = containerChargesRows.filter((row) => {
        ...
        <div className="container-charges-root">
            ...
            <main className="container-charges-content">
                <header className="container-charges-header">
                    <h1 className="container-charges-title">Container Charges</h1>
                    <p className="container-charges-subtitle">
                        View and search container charge transactions. Use the filters
                ...
                >
                    <div className="container-charges-search-group">
                        ...
                        >
                            {containerChargesColumns.map((col) => (
                ...
                <section
                    ...
                    aria-label="Container charges results"
                >
                    <table className="container-charges-table">
                        ...
                        <tbody>
                            {paginatedRows.length === 0 ? (
                                <tr>
                                    <td
                                        colSpan={containerChargesColumns.length}
